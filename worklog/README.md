...
## 색인
- [2026-09-12](2026-09-12.md) — [CC] dist 재빌드·리허설 / 배치 A: 판정 추적(provenance)·명령 안전 정책(로더+엔진)·룰팩 SHA 기록·CI / 배치 B: 조치 분류·대시보드 조치율·리포트 게이트·dry-run·연결 사전검증 / 배치 C: 세션 패키지·자산 메타·위험도·예외 승인·수동확인 템플릿 / 배치 D: Rule Tester·룰팩 diff·fixture 커버리지 / 룰 fixture 484케이스 → 선언 판정 195/195. 테스트 804
